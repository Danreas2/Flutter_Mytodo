...
class _updatePageState extends State<updatePage> {
  ...
  void initState() {
    ...
    _dueDate = DateTime.parse(widget.todo['due_date']);
    _completed = int.parse(widget.todo['completed']);
  }

  Future _saveTodo() async {
    String url = "http://192.168.18.7/api_flutter/todo/public/api/task/$id";
